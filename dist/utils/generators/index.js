...
function generateUpdateContactObject(contactDataToUpdate) {
  ...
  if (contactDataToUpdate.updated_at === null || contactDataToUpdate.updated_at) {
...
function generateUpdateContactDataObject(contactDataDataToUpdate) {
  ...
  if (contactDataDataToUpdate.updated_at === null || contactDataDataToUpdate.updated_at) {
...
function generateUpdateLoadInfoDataObject(loadInfoDataToUpdate) {
  ...
  if (loadInfoDataToUpdate.updated_at === null || loadInfoDataToUpdate.updated_at) {
